...
init_feature = pd.read_csv('./std_file/init.csv', index_col = 0)
...
class PredictDataset(InMemoryDataset):
	...
	def processed_file_names(self):
		return ['E:/MVIMG_size4/dataset_root_u2/predict_set.pt']
...
predict_set = PredictDataset(root='E:/MVIMG_size4/dataset_root_u2/')
